vim.api.nvim_set_hl(0, "blue",   { bg = col, underline = false, bold = true, fg = "#3d59a1" }) 
vim.api.nvim_set_hl(0, "green",  { bg = col, underline = false, bold = true, fg = "#9ece6a" }) 
vim.api.nvim_set_hl(0, "yellow", { bg = col, underline = false, bold = true, fg = "#FFFF00" }) 
vim.api.nvim_set_hl(0, "orange", { bg = col, underline = false, bold = true, fg = "#f09000" }) 
